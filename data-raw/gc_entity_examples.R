...
usethis::use_data(studies_ex01, compress = "xz", overwrite = TRUE)
usethis::use_data(studies_ex02, compress = "xz", overwrite = TRUE)
usethis::use_data(associations_ex01, compress = "xz", overwrite = TRUE)
usethis::use_data(associations_ex02, compress = "xz", overwrite = TRUE)
usethis::use_data(variants_ex01, compress = "xz", overwrite = TRUE)
usethis::use_data(variants_ex02, compress = "xz", overwrite = TRUE)
usethis::use_data(traits_ex01, compress = "xz", overwrite = TRUE)
usethis::use_data(traits_ex02, compress = "xz", overwrite = TRUE)
